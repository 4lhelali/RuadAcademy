<?php
  // api/upload.php
  // Handles image uploads - saves to the site root images/ folder and returns the URL
  ...
  if (!in_array($file['type'], $allowedTypes)) {
      http_response_code(400);
      echo json_encode(['error' => 'Invalid file type. Only JPG, PNG, WebP, and GIF allowed']);
      exit();
  }
