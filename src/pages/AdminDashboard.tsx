...
// ─── Local image upload ──────────────────────────────────────────────────────
// Uploads image to /api/upload.php which saves to public/images/
...
export default function AdminDashboard() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Save post to database with the uploaded image URL
      ...
      showNotification("error", err instanceof Error ? err.message : "Failed to create post");
    } finally {
      setSubmitting(false);
    }
  }
